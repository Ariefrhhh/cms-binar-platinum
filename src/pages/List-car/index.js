  ...
  const handleConfirmDelete = async () => {
    try {
      await Services().delete(
        `https://bootcamp-rent-cars.herokuapp.com/admin/car/${carIdToDelete}`,
        {
          headers: {
            access_token: localStorage.getItem("ACCESS_TOKEN"),
          },
      ...
      setCarData((prevCarData) =>
        prevCarData.filter((car) => car.id !== carIdToDelete)
      );
      setShow(false);
                    ...
                    <CardBody className="ps-4 ">
                      ...
                      <CardSubtitle className="pb-5">
                        ...
                        <div className="d-flex">
                          ...
                          <p>
                            Updated at {new Date(car.updatedAt).getDate()}{" "}
                      ...
                      <div className="d-flex gap-3 justify-content-center pb-4">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            navigate("/editcar", { state: { carId: car.id } })
                          }
                          color="success"
                        >
          ...
          <Modal id="modalDelete" isOpen={show} toggle={handleClose} centered>
            <ModalBody>
              <figure className="d-flex justify-content-center">
                <img
                  src={modalDeleteImage}
                  className="img-fluid deleteModalImage"
                  alt="Mobil Delete"
                />
              </figure>
